...
<aside className="main-sidebar sidebar-light-warning elevation-4">
  {/* Brand Logo */}
  <a  className="brand-link bg-warning">
  <Link to="/" className="brand-link" onClick={()=>{sidebar.setState({"url":""})}}>Qualitex
    ...
    <nav className="mt-2">
      <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li className="nav-item menu-open">
          <a href="#"  className={ location.pathname === '/page' ? 'nav-link active':'nav-link'}>
          ...
          <ul className="nav nav-treeview">
            <li className="nav-item">
              <a  className="nav-link">
                <Link to="page" onClick={()=>{sidebar.setState({"url":"page"})}}>
